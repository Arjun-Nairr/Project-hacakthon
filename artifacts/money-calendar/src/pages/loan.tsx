  ...
  return (
    <section className="mt-5 overflow-hidden rounded-[18px] border border-[#E4E7EC] bg-white p-4 shadow-sm" data-testid="section-loan-result">
      ...
      <div className="mt-5 grid grid-cols-3 gap-2">
        ...
        <Metric label="Lowest bal" value={moneyShort(result.calendar.lowestBalance)} hint={`In ${result.calendar.worstMonth}`} good={result.calendar.lowestBalance >= 0} />
      </div>
      ...
      <div className="mt-2 grid grid-cols-3 gap-2">
        ...
        <Metric label="Resilience" value={`${result.resilience.monthsSurvived} mo`} hint="No fresh income" good={result.resilience.monthsSurvived >= 3} />
      </div>
        ...
        <section className="mt-6 rounded-[18px] border border-[#E4E7EC] bg-white p-4" data-testid="section-loan-form">
          ...
          {calendar && (
            <div className="mt-5 border-t border-[#EEF1F3] pt-4 text-[10px] leading-4 text-[#667085]">
              <span className="font-semibold text-[#003B73]">Using {calendar.monthLabel}.</span> This decision will be read against your seeded salary and cash-flow calendar.
            </div>
          )}
        </section>
