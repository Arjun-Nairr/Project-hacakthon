...
export const getPostAgentChatUrl = () => {
 ...
 */
export const postAgentChat = async (agentChatRequest: AgentChatRequest, options?: Parameters<typeof customFetch>[1]): Promise<AgentChatResponse> => {
...
return customFetch<AgentChatResponse>(getPostAgentChatUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
...
export const getPostAgentChatMutationKey = () => ['postAgentChat'] as const;

export const getPostAgentChatMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAgentChat>>, TError,PostAgentChatMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof postAgentChat>>, TError,PostAgentChatMutationVariables, TContext> => {

const mutationKey = getPostAgentChatMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAgentChat>>, PostAgentChatMutationVariables> = (props) => {
          const {data} = props ?? {};

          return  postAgentChat(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAgentChatMutationResult = NonNullable<Awaited<ReturnType<typeof postAgentChat>>>
    export type PostAgentChatMutationBody = BodyType<AgentChatRequest>
    export type PostAgentChatMutationError = ErrorType<unknown>
    export type PostAgentChatMutationVariables = {data: BodyType<AgentChatRequest>}

    /**
 * @summary Read-only Hermes chat turn grounded in existing financial data
 */
export const usePostAgentChat = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAgentChat>>, TError,PostAgentChatMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof postAgentChat>>,
        TError,
        PostAgentChatMutationVariables,
        TContext
      > => {
      return useMutation(getPostAgentChatMutationOptions(options));
    }
